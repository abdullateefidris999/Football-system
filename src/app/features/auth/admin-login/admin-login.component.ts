...
@Component({
  ...
  template: `
    <div class="min-h-screen relative flex items-center justify-center">
      ...
      <div class="absolute inset-0 bg-cover bg-center" style="background-image: url('images/admin-background.jpeg');">
      ...
      <div class="relative z-10 w-full max-w-md mx-4">
        <div class="bg-white dark:bg-surface-600 rounded-2xl shadow-2xl overflow-hidden">
          <!-- Card Header with Logo -->
          <div class="bg-gradient-to-r from-red-500 to-red-500 px-8 py-8 text-center">
            <img 
          ...
          <div class="px-8 py-8">
            <form [formGroup]="form" (ngSubmit)="onSubmit()">
              ...
              <div class="mb-5">
                <label for="email" class="block text-sm font-semibold mb-2 text-surface-700 dark:text-surface-200">
                  <i class="pi pi-envelope mr-2 text-red-500"></i>Email Address
                </label>
                <input 
                  pInputText 
                  id="email" 
              ...
              <div class="mb-6">
                <label for="password" class="block text-sm font-semibold mb-2 text-surface-700 dark:text-surface-200">
                  <i class="pi pi-lock mr-2 text-red-500"></i>Password
                </label>
                <p-password 
                  id="password" 
            ...
            <div class="flex items-center my-6">
              <div class="flex-1 border-t border-surface-200 dark:border-surface-600"></div>
              <span class="px-4 text-sm text-surface-400">or</span>
              <div class="flex-1 border-t border-surface-200 dark:border-surface-600"></div>
            </div>
            ...
            <p class="text-center text-sm text-surface-600 dark:text-surface-400">
              ...
              <a routerLink="/team/login" class="text-red-600 hover:text-red-700 font-semibold hover:underline ml-1">
                Team Login
              </a>
            </p>
          </div>
